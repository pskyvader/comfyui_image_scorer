...
def _add_database_parser(
    ...
    cleanup = database_sub.add_parser(
...
def _add_files_parser(
    ...
    cleanup_parser = files_sub.add_parser(
        "cleanup",
...
def main() -> int:
    ...
    files_parser, files_remove_parser, files_download_parser, files_cleanup_parser = (
